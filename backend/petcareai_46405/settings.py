"""
Django settings for petcareai_46405 project.
...
ROOT_URLCONF = 'petcareai_46405.urls'
...
WSGI_APPLICATION = 'petcareai_46405.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "petcareai_46405 API",
    "DESCRIPTION": "API documentation for petcareai_46405 App",
    "VERSION": "v1",
}
